...
const ContestList = () => {
    ...
    const fetchContests = async() => {
        ...
        const res = await axios.get(BASE_URL+"/contests/platform/all?startDate="+ new Date().toISOString() ,{
            withCredentials : true
        })
        console.log(res);
...
if(!contests || contests.length === 0) return <ShimmerList />
  return (
    ...
    <div className='flex-col h-screen overflow-scroll scrollbar-hide'><div className="font-bold montserrat-logo text-3xl mx-8">Upcoming Contests</div>
